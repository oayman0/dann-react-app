...
<Navbar fixed={"top"} className="navbar">
    ...
    <Container fluid={"true"} className="fixed-top shadow-sm p-2 mb-0 bg-white">
         <Row>
              ...
              <Link to="/favourite" className="btn"><i className="fa h4 fa-heart"></i><sup><span className="badge text-white bg-warning">3</span></sup>                  
                   </Link>

                   <Link to="/notification" className="btn"><i className="fa h4 fa-bell"></i><sup><span className="badge text-white bg-warning">5</span></sup>                  
                   </Link>
