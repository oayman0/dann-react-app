      ...
      <div className="divide-y divide-gray-700 w-full">
        ...
        <div className="flex items-center justify-between pt-2.5">
          <div className="flex items-center">
            <div className="icon" style={{ margin: 5 }} onClick={() => filePickerRef.current.click()}>
            ...
            <div className="icon rotate-90" style={{ margin: 5 }}>
                <ChartBarIcon className="text-[#1d9bf0] h-[22px]" />
              </div>

              <div className="icon" style={{ margin: 5 }} onClick={() => setShowEmojis(!showEmojis)}>
